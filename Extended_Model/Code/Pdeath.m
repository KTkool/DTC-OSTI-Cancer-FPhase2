...
function [ y ] = Pdeath(params,State,Hydrogen)
    ...
    mask = logical((Hydrogen < params.hn)  .*  ((State==1) + (State==2)+(State==5) + (State==6)+(State==9) + (State==10)+(State==13) + (State==14))); 
    ...
    mask = logical((Hydrogen < params.ht)  .*   ((State==3) + (State==4)+(State==7) + (State==8)+(State==11) + (State==12)+(State==15) + (State==16)));
