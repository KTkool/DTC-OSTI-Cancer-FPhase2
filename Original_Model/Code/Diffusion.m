...
%---------------------------ADDED DRUG SPECIES------------%
if species == 2; %for drug
    
    drg = ones(1,N*M);
    drg(states == 0) = 1; %label all cells with a 1, since diffusion will happen independent of state
    vec_delta = params.dd * drg; %factored by params.dd
end
